...
import java.sql.*;
import com.SearchModel.Query_and_Ranker.Ranker.TF;
import com.SearchModel.Query_and_Ranker.Ranker.IDF;
import com.SearchModel.Query_and_Ranker.Ranker.ScoreTf_Idf;
import com.SearchModel.Query_and_Ranker.Ranker.FinalScore;
import com.SearchModel.Query_and_Ranker.Ranker.Geographic_and_DatePublished;
...
public class NewQueryProcessor {
	 ...
	 public static void main(String[] args) throws IOException {
		  ...
		  if(SearchQuery.charAt(0)=='"' && SearchQuery.charAt(SearchQuery.length()-1)=='"'  ) {
			  PhraseSearching=true;

		  }
		  Queryword = SearchQuery.replace("\"", "");
		  tokens.add(Queryword.toLowerCase());
...
//		String deleteQuery = "TRUNCATE TABLE rankedurls1";
       ...
       try {
    	   CountQuery = "SELECT COUNT(*) FROM userqueries WHERE id = '"+id+"' AND Query= '"+SearchQuery+"' ";
